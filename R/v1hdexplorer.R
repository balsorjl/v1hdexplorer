...
#' Installs Packages
#'
#' @param some.packages Installs only required packages. These include: corrplot,dendextend,factoextra,FactoMineR,ggplot2,gplots,Hmisc,psych,RColorBrewer,RSKC,Rtsne,seriation,sparcl,stats,tsne, vioplot.
...
install.HDpackages<- function(some.packages,all.packages){
  some.packages<-c("corrplot","dendextend","factoextra","FactoMineR","ggplot2","gplots","Hmisc","psych","RColorBrewer","RSKC","Rtsne","seriation","sparcl","stats","tsne","vioplot")
  all.packages<-c("corrplot","dendextend","factoextra","FactoMineR","ggplot2","gplots","Hmisc","psych","RColorBrewer","RSKC","Rtsne","seriation","sparcl","stats","tsne","vioplot","autoimage","data.table","d3heatmap","dendsort","GGally","ggpubr","ggrepel","gridExtra","miscTools","plotrix","plyr","reshape","scales")
  install_packages(some.packages,all.packages)
}

#' Loads Packages
#'
#' @param some.packages Loads only required packages. These include: corrplot,dendextend,factoextra,FactoMineR,ggplot2,gplots,Hmisc,psych,RColorBrewer,RSKC,Rtsne,seriation,sparcl,stats,tsne, vioplot.
